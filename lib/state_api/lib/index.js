...
class DataAPI{
    ...
    generateNotifyFunc(field){
        ...
        //Note: arrow function doesn't bind it's own arguments object so have to use explicit rest parameter. https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/rest_parameters
        return (...args) =>{
            const KEY = 0, VALUE = 1;
    ...
    startClock = () => {
        setInterval(()=> {
            ...
            this.notifyUpdateToTimestamp(this.data.timestamp);
        }, 1000);
    };
